  ...
  return (
    <div className="home-container">
      ...
      <ContentSection>
        <h1>We Can Help</h1>
        <p>
          We provide the opportunity for healthcare organizations to share their
          internal knowledge, externally. If pictures are worth a thousand
          words, what's a video?
        </p>
        ...
        <p>
          Thousands of users are satisfied with what they get with Beaker
          Health. When you use Beaker Health, you might be surprised with what
          you already possess.
        </p>
        ...
        <div className="section__img-row">
          <div>
            ...
            <h2>Time Savings</h2>
            <p>
              Reports show 50% time savings of creation & dissemination
              processes
            </p>
          </div>
          ...
          <div>
            ...
            <h2>One-Stop</h2>
            <p>
              Users are able to upload, view, and track metrics in one
              dashboard.
            </p>
          </div>
          ...
          <div>
            ...
            <h2>Efficient</h2>
            <p>
              We create certificates, reports, and monthly payouts in seconds.
            </p>
          </div>
        </div>
      </ContentSection>
      ...
      <ContentSection gray={true}>
        ...
        <div className="section__img-text-row">
          <div className="text">
            <h2>Innovation at it's finest</h2>

            <p>
              <span>Use what you possess, more efficiently.</span>
              <span>
                Have individuals from inside your organization upload knowledge
                to create your own presentation library. This creates a
                customized E-Learning platform that allows you to:
              </span>
      ...
      <ContentSection>
        <h1>Built for You</h1>
        <p>You already own it. We help make it known.</p>
        <div className="section__img-text-row">
          <div className="large">
          ...
          <div className="text">
            <h2>Educator</h2>
            <p>
              Organizations set who present. Educators easily enter appropriate
              criteria, upload and record. We take care of the rest.
            </p>
      ...
      <ContentSection>
        <div className="section__img-text-row">
          <div className="text">
            <h2>Learner</h2>
            <p>
              Finding the right information is easy as 1-2-3 with our search and
              evaluation tools to save ample time.for any learner.
            </p>
      ...
      <ContentSection>
        <div className="section__img-text-row">
          ...
          <div className="text">
            <h2>Educator</h2>
            <p>
              It's your organization. You control the insights, set permissions,
              and generate reports on what matters most to you.
            </p>
